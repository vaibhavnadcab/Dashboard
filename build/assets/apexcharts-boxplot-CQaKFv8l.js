(function () {
  var e = {
      ...
      plotOptions: {
        boxPlot: { colors: { upper: "#5c67f7", lower: "#e354d4" } },
      },
      xaxis: {
        labels: {
          show: !0,
    ...
    t = new ApexCharts(document.querySelector("#boxplot-basic"), e);
  t.render();
  var e = {
      series: [
        {
    ...
    t = new ApexCharts(document.querySelector("#boxplot-scatter"), e);
  t.render();
  var e = {
      series: [
        {
      ...
      plotOptions: {
        ...
        boxPlot: { colors: { upper: "#e9ecef", lower: "#f8f9fa" } },
      },
      grid: { borderColor: "#f2f5f7" },
      xaxis: {
        labels: {
    ...
    t = new ApexCharts(document.querySelector("#boxplot-horizontal"), e);
  t.render();
})();
